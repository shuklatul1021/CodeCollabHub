...
CSRF_TRUSTED_ORIGINS = os.getenv('CSRF_TRUSTED_ORIGINS', 'https://*.vercel.app,http://localhost:8000,http://127.0.0.1:8000').split(',')
...
DATABASES = {
    'default': dj_database_url.config(
        default=os.getenv('DATABASE_URL', 'postgresql://neondb_owner:npg_uXA2CHdO5eIx@ep-raspy-scene-a49n7gjw-pooler.us-east-1.aws.neon.tech:5432/neondb?sslmode=require'),
        conn_max_age=600,
